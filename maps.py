    ...
    def __init__(self,game,path='maps/map_test.json'):
        ...
        try:
           with open(path,'r',encoding='utf=8') as f:
            ...
            return
        self.routeIndex=mapInfoDict['routeIndex']#routeIndex[routeNum][location]=(x,y)
        self.mapTaskList=mapInfoDict['mapTaskList']#mapTaskList[waveNum][routeNum][taskLoc]=task
